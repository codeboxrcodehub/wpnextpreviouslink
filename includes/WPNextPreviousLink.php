...
class WPNextPreviousLink {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/WPNextPreviousLinkHelper.php';
	...
	private function define_admin_hooks() {
		...
		add_action( 'after_plugin_row_wpnextpreviouslinkaddon/wpnextpreviouslinkaddon.php', [ $plugin_admin, 'custom_message_after_plugin_row_proaddon' ], 10, 2 );
