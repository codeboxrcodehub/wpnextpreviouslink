...
class WPNextPreviousLinkPublic {
	...
	public function enqueue_scripts() {
		...
		$wpnp_ga_enabled      = $settings->get_field( 'wpnp_ga_enabled', 'wpnextpreviouslink_ga', 'off' );
		$wpnp_ga_track_views  = $settings->get_field( 'wpnp_ga_track_views', 'wpnextpreviouslink_ga', 'on' );
		$wpnp_ga_track_clicks = $settings->get_field( 'wpnp_ga_track_clicks', 'wpnextpreviouslink_ga', 'on' );
		$wpnp_ga_track_pbr    = $settings->get_field( 'wpnp_ga_track_pbr', 'wpnextpreviouslink_ga', 'on' );
	...
	public function wordPress_next_previous_link() {
		...
		$show_home     = intval( $settings->get_field( 'wpnp_show_home', 'wpnextpreviouslink_basics', 1 ) );
		$show_archive  = intval( $settings->get_field( 'wpnp_show_archive', 'wpnextpreviouslink_basics', 1 ) );
		$show_category = intval( $settings->get_field( 'wpnp_show_category', 'wpnextpreviouslink_basics', 1 ) );
		$show_tag      = intval( $settings->get_field( 'wpnp_show_tag', 'wpnextpreviouslink_basics', 1 ) );
		$show_author   = intval( $settings->get_field( 'wpnp_show_author', 'wpnextpreviouslink_basics', 1 ) );
		$show_date     = intval( $settings->get_field( 'wpnp_show_date', 'wpnextpreviouslink_basics', 1 ) );
		...
		$image_name    = $settings->get_field( 'wpnp_image_name', 'wpnextpreviouslink_basics', 'arrow' );
		$style_top     = intval( $settings->get_field( 'wpnp_style_top', 'wpnextpreviouslink_basics', 50 ) );
		$z_index       = intval( $settings->get_field( 'wpnp_z_index', 'wpnextpreviouslink_basics', 1 ) );
		$unit_type     = $settings->get_field( 'wpnp_unit_type', 'wpnextpreviouslink_basics', '%' );
		$wpnp_skip_ids = esc_attr( $settings->get_field( 'wpnp_skip_ids', 'wpnextpreviouslink_basics', '' ) );
		...
		$post_to_show         = intval( $settings->get_field( 'wpnp_show_post', 'wpnextpreviouslink_basics', 1 ) );         //show post next(2) or prev(1)
		$show_both_in_archive = intval( $settings->get_field( 'wpnp_show_post_archive', 'wpnextpreviouslink_basics', 1 ) ); //show both next and prev in archive
		$show_both_in_single  = intval( $settings->get_field( 'wpnp_show_post_single', 'wpnextpreviouslink_basics', 1 ) );  //show both next and prev in single
		$new_window           = intval( $settings->get_field( 'wpnp_new_window', 'wpnextpreviouslink_basics', 0 ) );        //link target
		...
		if ( $this->is_page_front_page() || is_singular() ) {
			$same_cat       = intval( $settings->get_field( 'wpnp_same_cat', 'wpnextpreviouslink_basics', 0 ) );
			$same_post_cats = $settings->get_field( 'navigate_postcats', 'wpnextpreviouslink_postcats', [] );
...
}//end class WPNextPreviousLinkPublic